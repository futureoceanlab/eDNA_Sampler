...
#include "TSYS01.h"
// Custom libraries
#include "src/sampler.h"                // verifies conditions for pump control
#include "src/samplerHelper.h"          // helper functions
#include "src/samplerWiFi.h"            // module that handles WiFi connection/comms
#include "src/samplerGlobals.h"         // contains all of the global variables
